...
export function Button(props) 
{
    ...
    return(
        <button className={props.className} style={buttonStyle}>{props.buttonText}</button>
    )
}
/*
...
export function InputBox(props)
{
    ...
    return (
        <input className={props.className} style={inputBoxStyle} placeholder={props.placeHolder} autoComplete={props.autoComplete}></input>
        )
}
/*
...
export function PasswordBox(props) {
    ...
    return (
        <input className={props.className} type='password' style={passwordBoxStyle} placeholder={props.placeHolder} required></input>
        )
}
/*
...
export function TextBox(props) {
    ...
    return (
      <textarea className={props.className} style={textBoxStyle} rows={props.rows} cols={props.cols} placeholder={props.placeHolder} />
    );
}
/*
...
export function DropDown(props)
{
    ...
    return(
        <CFormSelect className={props.className} aria-label={props.label} 
            style={dropDownStyle} options={props.options} />
        )
}
/*
